...
#Note2: Windows Users will also not be able to use imagesnap but you can use pygame to take photos instead see links below...
# https://stackoverflow.com/questions/23175486/taking-webcam-photos-in-python-3-and-windows
...
def take_photo(photo_name):
	os.system("CommandCam /filename "+ photo_name)
	return os.path.join(Here,photo_name)
